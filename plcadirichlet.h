#ifndef _PLCADIRICHLET_H
#define _PLCADIRICHLET_H
#include "fastmath.h"
...
/*
  ...
  *************** Notice *****************
  1 To achieve the optimal speed, you should use the BLAS library shipped with your machine.
    ...
    in plcadirichlet_BLAS.cpp to your blas header file.
  ...
  2 If you don't have a native blas library, then you need to install BLAS and CBLAS. You just need to go to these two directories and type "make all". And you can use the configuration for BLASLIB and BLASHEADER in the provided Makefile. You can type "make testplcadirichlet_BLAS" to see how to compile it. Notice: if you use the non-native BLAS library, plcadirichlet_BLAS is not guaranteed to be faster than plcadirichlet.
 */
