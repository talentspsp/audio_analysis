...
int main()
{
  ...
  cout<<"file1's components are"<<endl;
  // printmat(A.get_pfz(),A.get_numcomp(),A.get_lenf());
  mat2asc("03a01Fa_comps.ascii", A.get_numcomp(),A.get_lenf(),A.get_pfz());
  A.add_comps();
  ...
  // printmat(A.get_pfz(),A.get_numcomp(),A.get_lenf());
  mat2asc("03a01Nc_comps.ascii", A.get_numcomp(),A.get_lenf(),A.get_pfz());
  A.add_comps();
